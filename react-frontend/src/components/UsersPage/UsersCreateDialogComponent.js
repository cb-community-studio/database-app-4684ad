...
const UsersCreateDialogComponent = (props) => {
    ...
    const onSave = async () => {
        let _data = {
            ...
            isAtvice: _entity.isAtvice,
            emailVerified: _entity.emailVerified,
            isBlocked: _entity.isBlocked,
        };
    ...
    return (
        <Dialog header="Create" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            ...
            <div>
                ...
                <Checkbox checked={_entity?.isAtvice} onChange={ (e) => setValByKey("isAtvice", e.checked)}  ></Checkbox>
            </div>
            <div>
                <p className="m-0">Email Verified:</p>
                <Checkbox checked={_entity?.emailVerified} onChange={ (e) => setValByKey("emailVerified", e.checked)}  ></Checkbox>
            </div>
            <div>
                <p className="m-0">Blocked:</p>
                <Checkbox checked={_entity?.isBlocked} onChange={ (e) => setValByKey("isBlocked", e.checked)}  ></Checkbox>
            </div>
