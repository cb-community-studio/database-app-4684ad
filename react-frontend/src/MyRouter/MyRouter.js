...
import SingleClientsPage from "../components/ClientsPage/SingleClientsPage";
import EmailsPage from "../components/EmailsPage/EmailsPage";
import SingleEmailsPage from "../components/EmailsPage/SingleEmailsPage";
import SubscribersPage from "../components/SubscribersPage/SubscribersPage";
import SingleSubscribersPage from "../components/SubscribersPage/SingleSubscribersPage";
// ~cb-add-import~
        ...
        <div className={wrapperClass} onClick={onWrapperClick}>
            ...
            <MainLayout>
                <Switch>
                    ...
                    <Route path="/clients/:singleClientsId" component={SingleClientsPage} exact />
                    <Route path="/emails" component={EmailsPage} exact />
                    <Route path="/emails/:singleEmailsId" component={SingleEmailsPage} exact />
                    <Route path="/subscribers" component={SubscribersPage} exact />
                    <Route path="/subscribers/:singleSubscribersId" component={SingleSubscribersPage} exact />
                    {/* ~cb-add-route~ */}
